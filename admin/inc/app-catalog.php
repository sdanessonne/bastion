...
return [
    ...
    'chromium'  => ['name'=>'Ungoogled Chromium','icon'=>'🧭','cat'=>'Navigateurs','msi'=>false,'args'=>'/S','url'=>'https://github.com/ungoogled-software/ungoogled-chromium-windows/releases/latest','desc'=>'Chromium sans services Google (à récupérer depuis GitHub Releases).'],
    'tor'       => ['name'=>'Tor Browser','icon'=>'🧅','cat'=>'Navigateurs','msi'=>false,'args'=>'/S','url'=>'https://www.torproject.org/dist/torbrowser/13.5.1/torbrowser-install-win64-13.5.1_ALL.exe','desc'=>'Navigateur anonymisant (réseau Tor). Vérifier la politique d\'usage du service.'],

    // ── Bureautique & PDF ────────────────────────────────────────────────────
    'libre'     => ['name'=>'LibreOffice','icon'=>'📄','cat'=>'Bureautique & PDF','msi'=>true,'args'=>'/qn','url'=>'https://download.documentfoundation.org/libreoffice/stable/24.8.4/win/x86_64/LibreOffice_24.8.4_Win_x86-64.msi','desc'=>'Suite bureautique complète (texte, tableur, présentation, dessin).'],
    'onlyoffice'=> ['name'=>'ONLYOFFICE Desktop','icon'=>'📝','cat'=>'Bureautique & PDF','msi'=>false,'args'=>'/silent','url'=>'https://download.onlyoffice.com/install/desktop/editors/windows/onlyoffice-desktopeditors-x64.exe','desc'=>'Suite bureautique compatible avec les formats Microsoft Office.'],
    ...
    'foxit'     => ['name'=>'Foxit PDF Reader','icon'=>'📗','cat'=>'Bureautique & PDF','msi'=>false,'args'=>'/quiet','url'=>'https://cdn01.foxitsoftware.com/pub/foxit/reader/desktop/win/2024.1/FoxitPDFReader20241_enu_Setup.exe','desc'=>'Lecteur PDF complet (annotations, formulaires).'],
    'pdfsam'    => ['name'=>'PDFsam Basic','icon'=>'✂️','cat'=>'Bureautique & PDF','msi'=>false,'args'=>'/S','url'=>'https://github.com/torakiki/pdfsam/releases/latest','desc'=>'Fusionner, découper, faire pivoter des PDF (GitHub Releases).'],
    ...
    'audacity'  => ['name'=>'Audacity','icon'=>'🎙️','cat'=>'Multimédia','msi'=>false,'args'=>'/VERYSILENT /NORESTART','url'=>'https://github.com/audacity/audacity/releases/latest','desc'=>'Éditeur audio multipiste (GitHub Releases).'],
    ...
    'irfanview' => ['name'=>'IrfanView','icon'=>'🖼️','cat'=>'Multimédia','msi'=>false,'args'=>'/silent /assoc=1','url'=>'https://www.irfanview.info/files/iview472_x64_setup.exe','desc'=>'Visionneuse d\'images rapide et légère.'],
    'obs'       => ['name'=>'OBS Studio','icon'=>'📹','cat'=>'Multimédia','msi'=>false,'args'=>'/S','url'=>'https://github.com/obsproject/obs-studio/releases/latest','desc'=>'Enregistrement et diffusion vidéo (GitHub Releases).'],
    'handbrake' => ['name'=>'HandBrake','icon'=>'🎞️','cat'=>'Multimédia','msi'=>false,'args'=>'/S','url'=>'https://github.com/HandBrake/HandBrake/releases/latest','desc'=>'Convertisseur vidéo multiformat (GitHub Releases).'],
    ...
    'teams'     => ['name'=>'Microsoft Teams','icon'=>'👥','cat'=>'Communication','msi'=>true,'args'=>'/quiet','url'=>'https://statics.teams.cdn.office.net/production-windows-x64/enterprise/teamsbootstrapper.exe','desc'=>'Messagerie d\'équipe et visioconférence Microsoft.'],
    'slack'     => ['name'=>'Slack','icon'=>'💬','cat'=>'Communication','msi'=>true,'args'=>'/quiet','url'=>'https://slack.com/ssb/download-win64-msi','desc'=>'Messagerie d\'équipe et collaboration.'],
    ...
    'signal'    => ['name'=>'Signal Desktop','icon'=>'🔐','cat'=>'Communication','msi'=>false,'args'=>'/S','url'=>'https://updates.signal.org/desktop/signal-desktop-win-x64.exe','desc'=>'Messagerie chiffrée de bout en bout.'],
    ...
    'rustdesk'  => ['name'=>'RustDesk','icon'=>'🦀','cat'=>'Accès distant & réseau','msi'=>false,'args'=>'--silent-install','url'=>'https://github.com/rustdesk/rustdesk/releases/latest','desc'=>'Bureau à distance open source, auto-hébergeable (GitHub).'],
    'putty'     => ['name'=>'PuTTY','icon'=>'🔌','cat'=>'Accès distant & réseau','msi'=>true,'args'=>'/qn','url'=>'https://the.earth.li/~sgtatham/putty/latest/w64/putty-64bit-0.81-installer.msi','desc'=>'Client SSH / Telnet / série.'],
    'winscp'    => ['name'=>'WinSCP','icon'=>'📁','cat'=>'Accès distant & réseau','msi'=>false,'args'=>'/VERYSILENT /NORESTART','url'=>'https://winscp.net/download/WinSCP-6.3.4-Setup.exe','desc'=>'Client de transfert de fichiers SFTP / SCP / FTP.'],
    'filezilla' => ['name'=>'FileZilla','icon'=>'🦎','cat'=>'Accès distant & réseau','msi'=>false,'args'=>'/S','url'=>'https://dl2.cdn.filezilla-project.org/client/FileZilla_3.67.1_win64-setup.exe','desc'=>'Client FTP / FTPS / SFTP.'],
    ...
    'peazip'    => ['name'=>'PeaZip','icon'=>'🫛','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/S','url'=>'https://github.com/peazip/PeaZip/releases/latest','desc'=>'Archiveur libre multiformat (GitHub Releases).'],
    ...
    'powertoys' => ['name'=>'Microsoft PowerToys','icon'=>'🧰','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/quiet /norestart','url'=>'https://github.com/microsoft/PowerToys/releases/latest','desc'=>'Utilitaires avancés pour Windows (GitHub Releases).'],
    ...
    'sharex'    => ['name'=>'ShareX','icon'=>'📸','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/VERYSILENT /NORESTART','url'=>'https://github.com/ShareX/ShareX/releases/latest','desc'=>'Capture d\'écran et partage avancés (GitHub Releases).'],
    'greenshot' => ['name'=>'Greenshot','icon'=>'🟢','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/VERYSILENT /NORESTART','url'=>'https://github.com/greenshot/greenshot/releases/latest','desc'=>'Capture d\'écran légère avec éditeur (GitHub Releases).'],
    'rufus'     => ['name'=>'Rufus','icon'=>'💽','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/S','url'=>'https://github.com/pbatard/rufus/releases/latest','desc'=>'Création de clés USB bootables (GitHub Releases).'],
    'keepass'   => ['name'=>'KeePass','icon'=>'🔑','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/VERYSILENT /NORESTART','url'=>'https://sourceforge.net/projects/keepass/files/latest/download','desc'=>'Gestionnaire de mots de passe hors ligne.'],
    ...
    'crystaldisk'=>['name'=>'CrystalDiskInfo','icon'=>'💾','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/VERYSILENT','url'=>'https://sourceforge.net/projects/crystaldiskinfo/files/latest/download','desc'=>'État de santé des disques (S.M.A.R.T.).'],
    ...
    'notepad3'  => ['name'=>'Notepad3','icon'=>'📃','cat'=>'Archivage & utilitaires','msi'=>false,'args'=>'/VERYSILENT','url'=>'https://github.com/rizonesoft/Notepad3/releases/latest','desc'=>'Éditeur de texte léger (GitHub Releases).'],
    ...
    'keepassxc' => ['name'=>'KeePassXC','icon'=>'🗝️','cat'=>'Sécurité','msi'=>true,'args'=>'/quiet','url'=>'https://github.com/keepassxreboot/keepassxc/releases/latest','desc'=>'Gestionnaire de mots de passe multiplateforme (GitHub Releases).'],
    'clamwin'   => ['name'=>'ClamWin','icon'=>'🦪','cat'=>'Sécurité','msi'=>false,'args'=>'/VERYSILENT','url'=>'https://sourceforge.net/projects/clamwin/files/latest/download','desc'=>'Antivirus libre basé sur ClamAV.'],
    ...
    'git'       => ['name'=>'Git pour Windows','icon'=>'🔧','cat'=>'Développement','msi'=>false,'args'=>'/VERYSILENT /NORESTART','url'=>'https://github.com/git-for-windows/git/releases/latest','desc'=>'Système de gestion de versions (GitHub Releases).'],
    ...
    'winmerge'  => ['name'=>'WinMerge','icon'=>'🔀','cat'=>'Développement','msi'=>false,'args'=>'/VERYSILENT /NORESTART','url'=>'https://github.com/WinMerge/winmerge/releases/latest','desc'=>'Comparaison et fusion de fichiers/dossiers (GitHub Releases).'],
    ...
    'winget'    => ['name'=>'App Installer (winget)','icon'=>'📥','cat'=>'Développement','msi'=>false,'args'=>'','url'=>'https://aka.ms/getwinget','desc'=>'Gestionnaire de paquets en ligne de commande de Microsoft.'],

    // ── Graphisme & PAO ──────────────────────────────────────────────────────
    'inkscape'  => ['name'=>'Inkscape','icon'=>'🖊️','cat'=>'Graphisme & PAO','msi'=>true,'args'=>'/qn','url'=>'https://inkscape.org/gallery/item/44617/inkscape-1.3.2_2023-11-25_091e20e-x64.msi','desc'=>'Éditeur d\'images vectorielles (SVG).'],
    ...
    'paintnet'  => ['name'=>'Paint.NET','icon'=>'🖍️','cat'=>'Graphisme & PAO','msi'=>false,'args'=>'/auto','url'=>'https://github.com/paintdotnet/release/releases/latest','desc'=>'Retouche d\'images simple et efficace (GitHub Releases).'],
    'darktable' => ['name'=>'darktable','icon'=>'📷','cat'=>'Graphisme & PAO','msi'=>false,'args'=>'/S','url'=>'https://github.com/darktable-org/darktable/releases/latest','desc'=>'Développement de photos RAW (GitHub Releases).'],

    // ── Cloud & stockage ─────────────────────────────────────────────────────
    'nextcloud' => ['name'=>'Nextcloud Desktop','icon'=>'☁️','cat'=>'Cloud & stockage','msi'=>false,'args'=>'/S','url'=>'https://github.com/nextcloud/desktop/releases/latest','desc'=>'Client de synchronisation Nextcloud (GitHub Releases).'],
    'owncloud'  => ['name'=>'ownCloud Desktop','icon'=>'🌥️','cat'=>'Cloud & stockage','msi'=>false,'args'=>'/S','url'=>'https://download.owncloud.com/desktop/ownCloud/stable/latest/win/ownCloud-x64.exe','desc'=>'Client de synchronisation ownCloud.'],
    'syncthing' => ['name'=>'Syncthing (SyncTrayzor)','icon'=>'🔄','cat'=>'Cloud & stockage','msi'=>false,'args'=>'/VERYSILENT','url'=>'https://github.com/canton7/SyncTrayzor/releases/latest','desc'=>'Synchronisation de fichiers pair-à-pair (GitHub Releases).'],
    'winscp2'   => ['name'=>'FreeFileSync','icon'=>'🗂️','cat'=>'Cloud & stockage','msi'=>false,'args'=>'/SILENT','url'=>'https://freefilesync.org/download/FreeFileSync_Windows_Setup.exe','desc'=>'Synchronisation et sauvegarde de dossiers.'],
    ...
    'powershell7'=>['name'=>'PowerShell 7','icon'=>'⌨️','cat'=>'Runtimes & compléments','msi'=>true,'args'=>'/qn','url'=>'https://github.com/PowerShell/PowerShell/releases/latest','desc'=>'Shell et langage de script multiplateforme (GitHub Releases).'],

    // ── Métier & divers ──────────────────────────────────────────────────────
    'qgis'      => ['name'=>'QGIS','icon'=>'🗺️','cat'=>'Métier & divers','msi'=>true,'args'=>'/qn','url'=>'https://qgis.org/downloads/QGIS-OSGeo4W-3.34.9-1.msi','desc'=>'Système d\'information géographique (cartographie).'],
    ...
    'anki'      => ['name'=>'Anki','icon'=>'🃏','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://apps.ankiweb.net/downloads/current/anki-25.02-windows-qt6.exe','desc'=>'Cartes mémoire et révision espacée.'],
    'obsidian'  => ['name'=>'Obsidian','icon'=>'🪨','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://github.com/obsidianmd/obsidian-releases/releases/latest','desc'=>'Prise de notes en Markdown, base de connaissances (GitHub).'],
    'joplin'    => ['name'=>'Joplin','icon'=>'📓','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://github.com/laurent22/joplin/releases/latest','desc'=>'Prise de notes et tâches, chiffrable (GitHub Releases).'],
    'freecad'   => ['name'=>'FreeCAD','icon'=>'📐','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://github.com/FreeCAD/FreeCAD/releases/latest','desc'=>'Modélisation paramétrique 3D / CAO (GitHub Releases).'],
    'scribus'   => ['name'=>'Scribus','icon'=>'📰','cat'=>'Métier & divers','msi'=>false,'args'=>'/VERYSILENT','url'=>'https://sourceforge.net/projects/scribus/files/latest/download','desc'=>'Publication assistée par ordinateur (PAO).'],
    'stellarium'=> ['name'=>'Stellarium','icon'=>'🔭','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://github.com/Stellarium/stellarium/releases/latest','desc'=>'Planétarium virtuel (GitHub Releases).'],
    'kdenlive'  => ['name'=>'Kdenlive','icon'=>'✂️','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://download.kde.org/stable/kdenlive/24.05/windows/kdenlive-24.05.2_x64.exe','desc'=>'Montage vidéo non linéaire.'],
    'etcher'    => ['name'=>'balenaEtcher','icon'=>'🔥','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://github.com/balena-io/etcher/releases/latest','desc'=>'Écriture d\'images disque sur clés USB/SD (GitHub Releases).'],
