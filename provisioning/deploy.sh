...
www-data ALL=(root) NOPASSWD: /usr/local/sbin/proxyfibre-fonctions state, /usr/local/sbin/proxyfibre-fonctions enable *, /usr/local/sbin/proxyfibre-fonctions disable *
...
www-data ALL=(root) NOPASSWD: /usr/local/sbin/proxyfibre-admx list, /usr/local/sbin/proxyfibre-maj state, /usr/local/sbin/proxyfibre-mail state, /usr/local/sbin/proxyfibre-mail test *, /usr/local/sbin/proxyfibre-mail config, /usr/local/sbin/proxyfibre-wanip state, /usr/local/sbin/proxyfibre-vpn state, /usr/local/sbin/proxyfibre-vpn check, /usr/local/sbin/proxyfibre-vpn clients, /usr/local/sbin/proxyfibre-vpn up, /usr/local/sbin/proxyfibre-vpn down, /usr/local/sbin/proxyfibre-vpn import /run/bastion/vpn-import.conf, /usr/local/sbin/proxyfibre-lien state, /usr/local/sbin/proxyfibre-lien init, /usr/local/sbin/proxyfibre-lien config, /usr/local/sbin/proxyfibre-lien up, /usr/local/sbin/proxyfibre-lien down, /usr/local/sbin/proxyfibre-lien check, /usr/local/sbin/proxyfibre-lien role site, /usr/local/sbin/proxyfibre-lien role principal, /usr/local/sbin/proxyfibre-lien hub-config, /usr/local/sbin/proxyfibre-lien reendpoint
SUD
...
install -m755 "${REPO_DIR}/services/scripts/lien-veille.php" /usr/local/sbin/proxyfibre-lien-veille
