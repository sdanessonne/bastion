...
return [
    ...
    'foxit'     => ['manuel'=>'URL versionnee derriere un CDN','name'=>'Foxit PDF Reader','icon'=>'📗','cat'=>'Bureautique & PDF','msi'=>false,'args'=>'/quiet','url'=>'https://cdn01.foxitsoftware.com/pub/foxit/reader/desktop/win/2024.1/FoxitPDFReader20241_enu_Setup.exe','desc'=>'Lecteur PDF complet (annotations, formulaires).'],
    ...
    'teams'     => ['manuel'=>'Microsoft ne publie plus d URL directe stable','name'=>'Microsoft Teams','icon'=>'👥','cat'=>'Communication','msi'=>true,'args'=>'/quiet','url'=>'https://statics.teams.cdn.office.net/production-windows-x64/enterprise/teamsbootstrapper.exe','desc'=>'Messagerie d\'équipe et visioconférence Microsoft.'],
    ...
    'signal'    => ['manuel'=>'URL versionnee publiee dans un manifeste','name'=>'Signal Desktop','icon'=>'🔐','cat'=>'Communication','msi'=>false,'args'=>'/S','url'=>'https://updates.signal.org/desktop/signal-desktop-win-x64.exe','desc'=>'Messagerie chiffrée de bout en bout.'],
    ...
    'kdenlive'  => ['manuel'=>'index KDE sans arborescence previsible','name'=>'Kdenlive','icon'=>'✂️','cat'=>'Métier & divers','msi'=>false,'args'=>'/S','url'=>'https://download.kde.org/stable/kdenlive/24.05/windows/kdenlive-24.05.2_x64.exe','desc'=>'Montage vidéo non linéaire.'],
